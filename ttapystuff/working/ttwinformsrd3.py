...
class TTAPIReadForm(Form):
    ...
    def m_apiInstance_ConnectionStatusUpdate(self, sender, e):
        ...
        if e.Status.IsSuccess:
            ...
            self.m_req = ttapi.InstrumentLookupSubscription(self.m_apiInstance.Session, ttapi.Dispatcher.Current, ttapi.ProductKey(ttapi.MarketKey.Sgx, ttapi.ProductType.Future, "CN"), "Apr17")
