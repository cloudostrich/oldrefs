...
class TTAPIFunctions():
    ...
    def m_apiInstance_ConnectionStatusUpdate(self, sender, e):
        ...
        if e.Status.IsSuccess:
            ...
            self.m_req = ttapi.InstrumentLookupSubscription(self.m_apiInstance.Session, ttapi.Dispatcher.Current, ttapi.ProductKey(ttapi.MarketKey.Cme, ttapi.ProductType.Future, "YM"), "Mar17")
    ...
    def m_req_Update(self, sender, e):
        ...
        if e.Instrument != None and e.Error == None:
            ...
            for ofeed in e.Instrument.GetValidOrderFeeds():
                if ofeed.IsTradingEnabled:
                    print("Order Feed {0} is enabled for Trading".format(ofeed.ToString()))
                else:
                    print("Order Feed {0} NOT wroking/ trading... FUCK".format(ofeed.ToString()))
            """
            ...
            self.m_ts = tradebk.TradeSubscription(self.m_apiInstance.Session, ttapi.Dispatcher.Current)
            ...
            print("Instrument not found yet - but still searching...")
