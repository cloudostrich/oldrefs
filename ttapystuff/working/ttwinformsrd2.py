...
class TTAPIReadForm(Form):
    ...
    def __init__(self):
        ...
        self.Text = 'DavTrader'
        self.Name = 'DavTrader'
        self.STORE = 'hdtest2.h5'   # Note: another option is to keep the actual file open
        self.CACHE = {}
    ...
    def process_row(self, d, key, max_len=10):
        """
    ...
    def m_apiInstance_ConnectionStatusUpdate(self, sender, e):
        ...
        if e.Status.IsSuccess:
            ...
            self.m_req = ttapi.InstrumentLookupSubscription(self.m_apiInstance.Session, ttapi.Dispatcher.Current, ttapi.ProductKey(ttapi.MarketKey.Sgx, ttapi.ProductType.Future, "CN"), "Mar17")
...
##            print("Connection Success!")
    ...
    def m_ps_FieldsUpdated(self, sender, e):
        ...
        if ltp.HasChanged or ltq.HasChanged:
            ...
            d = {'time' : pd.datetime.now(), 'close' : ltpi}
            k = 'nk'
